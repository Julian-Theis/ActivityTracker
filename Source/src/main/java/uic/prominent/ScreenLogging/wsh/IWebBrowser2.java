...
public interface IWebBrowser2 extends uic.prominent.ScreenLogging.wsh.IWebBrowserApp {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param cmdID Mandatory uic.prominent.ScreenLogging.wsh.OLECMDID parameter.
   * @return  Returns a value of type uic.prominent.ScreenLogging.wsh.OLECMDF
   */

  @DISPID(501) //= 0x1f5. The runtime will prefer the VTID if present
  @VTID(53)
  uic.prominent.ScreenLogging.wsh.OLECMDF queryStatusWB(
    uic.prominent.ScreenLogging.wsh.OLECMDID cmdID);
   ...
   * </p>
   * @param cmdID Mandatory uic.prominent.ScreenLogging.wsh.OLECMDID parameter.
   * @param cmdexecopt Mandatory uic.prominent.ScreenLogging.wsh.OLECMDEXECOPT parameter.
  ...
  void execWB(
    uic.prominent.ScreenLogging.wsh.OLECMDID cmdID,
    uic.prominent.ScreenLogging.wsh.OLECMDEXECOPT cmdexecopt,
   ...
   * </p>
   * @return  Returns a value of type uic.prominent.ScreenLogging.wsh.tagREADYSTATE
   */

  @DISPID(-525) //= 0xfffffdf3. The runtime will prefer the VTID if present
  @VTID(56)
  uic.prominent.ScreenLogging.wsh.tagREADYSTATE readyState();
